...
@section('contenido')
    ...
    <section class="container-fluid p-2 bg-white">
        ...
        <div class="container-fluid row border-bottom">
            ...
            <div class="col-lg-6">
                <h1 class="fs-3 fw-semibold text-primary"><i class="fas fa-file-invoice-dollar"></i> Consumibles</h1>
                ...
                @if( count( $consumibles ) > 0 )
                    ...
                    @foreach ($consumibles as $consumible)
                        ...
                        <tr>
                            ...
                            <td>
                                <x-adminlte-button class="editar" icon="fas fa-edit" theme="info" data-toggle="modal" data-target="#modalEditar" data-id="{{ $consumible->id }}"></x-adminlte-button>
                                <x-adminlte-button class="borrar" icon="fas fa-trash" theme="danger" data-id="{{ $consumible->id }}"></x-adminlte-button>
                            </td>
                        </tr>
