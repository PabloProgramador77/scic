                ...
                @if( count( $permisos ) > 0 )
                    @foreach ($permisos as $permiso)
                        ...
                        <tr>
                            ...
                            <td>{{ $permiso->guard }}</td>
                            <td>
                                <x-adminlte-button class="editar" icon="fas fa-edit" theme="info" data-toggle="modal" data-target="#modalEditar" data-id="{{ $permiso->id }}" title="Editar permiso"></x-adminlte-button>
                                <x-adminlte-button class="borrar" icon="fas fa-trash" theme="danger" data-id="{{ $permiso->id }}" title="Borrar permiso"></x-adminlte-button>
                            </td>
                        </tr>
