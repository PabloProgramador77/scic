<x-adminlte-modal id="modalEditar" title="Editar Rol de Usuario" theme="info" icon="fas fa-edit" static-backdrop scrollable>
    ...
    <div class="container-fluid border-bottom">
        ...
        <form novalidate>
            <div class="form-group">
                <x-adminlte-input name="nombreEditar" id="nombreEditar" placeholder="Nombre de rol de usuario">
