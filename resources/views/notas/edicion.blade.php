...
@section('contenido')
    ...
    <section class="container-fluid p-2 bg-white">
        ...
        <div class="container-fluid row p-1">
            ...
            <x-adminlte-input class="col-lg-5" name="cliente" id="cliente" readonly="true" value="{{ $nota->cliente->nombre }}">
                <x-slot name="prependSlot">
                    <div class="input-group-text text-info">
            ...
            <x-adminlte-input class="col-lg-4" name="total" id="total" readonly="true" value="{{ $nota->total }}">
                <x-slot name="prependSlot">
                    <div class="input-group-text text-info">
            ...
            <x-adminlte-input class="col-lg-4" name="estado" id="estado" readonly="true" value="{{ $nota->estado }}">
                <x-slot name="prependSlot">
                    <div class="input-group-text text-info">
                    ...
                    <td>
                        <div class="row">
                            @foreach ($cotizacion->modelo->numeraciones as $numeracion)
                                <input type="number" name="numeracion" id="numeracion{{ $cotizacion->id }}" data-id="{{ $cotizacion->id }}" class="col-lg-1 col-md-1 col-sm-1 text-center" placeholder="#{{ $numeracion->numero }}" value="0">
                            @endforeach
                        </div>
                    </td>
