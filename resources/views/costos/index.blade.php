...
@section('contenido')
    ...
    <section class="container-fluid p-2 bg-white">
        ...
        <div class="container-fluid row p-2">
            ...
            <x-adminlte-datatable id="costos" :heads="$heads" :config="$config" theme="light" striped hoverable bordered compressed beautify>
                ...
                @if( count( $costos ) > 0 )
                    @foreach ($costos as $costo)
                        ...
                        <tr>
                            <td>{{ $costo->nombre }}</td>
                            <td>{{ ($costo->descripcion ? $costo->descripcion : 'Sin descripción') }}</td>
