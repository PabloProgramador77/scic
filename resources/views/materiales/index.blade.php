...
@section('contenido')
    ...
    <section class="container-fluid p-2 bg-white">
        ...
        <div class="container-fluid row border-bottom">
            ...
            <div class="col-lg-6">
                <h1 class="fs-3 fw-semibold text-primary">Materiales</h1>
                <p class="fs-6 fw-semibold text-secondary">Panel de Administrador</p>
            </div>
            <div class="col-lg-5 my-2">
                <a href="{{ url('/proveedores') }}" class="btn btn-secondary p-2 fw-semibold rounded mx-1">Proveedores de Materiales</i></a>
            </div>
