<x-adminlte-modal id="modalCostos" title="Costos Base y Neutros" theme="warning" icon="fas fa-file-invoice-dollar" static-backdrop scrollable size="xl">
    ...
    <x-slot name="footerSlot">
        <x-adminlte-button theme="primary" label=" Continuar" id="agregar" icon="fas fa-arrow-circle-right" disabled="true"></x-adminlte-button>
