<x-adminlte-modal id="modalPreeliminar" title="Cotización de Modelo" size="xl" theme="warning" icon="fas fa-file-invoice" static-backdrop scrollable>
    ...
    <x-slot name="footerSlot">
        <x-adminlte-button theme="info" label="Guardar" id="agregarSuelaNueva" icon="fas fa-save"></x-adminlte-button>
        <x-adminlte-button theme="primary" label="Actualizar" id="agregarSuela" icon="fas fa-sync-alt"></x-adminlte-button>
